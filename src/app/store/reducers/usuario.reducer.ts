...
const estadoInicial: UsuarioState = {
    user: null, // iniciamos a null xq al inicio no tendremos ningún usuario
    loaded: false,
    loading: false,
    error: null // iniciamos a null xq al inicio no tendremos tampoco ningún error
};
    ...
    switch ( action.type ) {
        ...
        case fromUsuario.CARGAR_USUARIO_SUCCESS:
            return {
                ...
                loading: false,
                loaded: true,
                user: {...action.usuario} // lo ponemos etre llaves con el ... para romper la referencia
            };
